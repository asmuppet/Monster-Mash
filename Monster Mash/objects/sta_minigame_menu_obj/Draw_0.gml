...
if !StaMinigameControllerObj.minigame_play && !StaMinigameControllerObj.minigame_end && choice_made && !intro_message{
	//menu background
...
else if !StaMinigameControllerObj.minigame_play && StaMinigameControllerObj.minigame_end {
	if StaMinigameControllerObj.sta_earned == 0 {
		draw_sprite_ext(sprite_index, image_index, x, y, width/sprite_width, height + space_text/sprite_height, 0, c_white, 1)
