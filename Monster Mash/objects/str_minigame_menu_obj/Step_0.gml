...
minimessage[2] = "Congratulations! Your monster trained hard and earned " + string((PlayerMonster.str_mult * StrMinigameControllerObj.str_earned * potion_mult)/10) + " strength!"